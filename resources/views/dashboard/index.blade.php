        ...
        <div class="content-wrapper">
                ...
                <div class="col-md-12 grid-margin">
                    <div class="row">
                        <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                            <h3 class="font-weight-bold">MAG NEWS</h3>
                        </div>
            ...
            <div class="row">
                <div class="col-md-6 grid-margin stretch-card">
                    <div class="card tale-bg">
                        <div class="card-people p-0 mt-auto">
                            <img src="{{ asset('assetPublic/images/istockphoto-1182477852-612x612.jpg') }}" height="250px" alt="people">
                            <div class="weather-info">
                                <div class="d-flex">
                                    <div>
                                        <h2 class="mb-0 font-weight-normal text-white"><i class="icon-sun mr-2 text-white"></i>31<sup>C</sup></h2>
                                    </div>
                                    <div class="ml-2">
                                        <h4 class="location font-weight-normal text-white">Palestine</h4>
                                        <h6 class="font-weight-normal text-white">Jerusalem</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-6 grid-margin transparent">
                    <div class="row">
                        <a href="{{ route('categoryShow') }}" style="text-decoration: none;cursor: pointer;"
                        ...
                        <a href="{{ route('newsShow') }}" style="text-decoration: none;cursor: pointer;"
                            class="col-md-6 mb-4 stretch-card transparent">
                            <div class="card card-dark-blue">
                                <div class="card-body">
                                    <p class="mb-4">Latest</p>
                                    <p class="fs-30 mb-2">News</p>
                                    <p></p>
                                </div>
                            </div>
                        </a>
                    ...
                    <div class="row">
                        <a href="{{ route('showComments') }}" style="text-decoration: none;cursor: pointer;"
                        ...
                        <a href="{{ route('showAdmins') }}" style="text-decoration: none;cursor: pointer;"
                            class="col-md-6 stretch-card transparent">
                            <div class="card card-light-danger">
                                <div class="card-body">
                                    <p class="mb-4">Network</p>
                                    <p class="fs-30 mb-2">Admins</p>
                                    <p></p>
                                </div>
                            </div>
                        </a>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <ul class="icon-data-list">
                                <li>
                                    <div class="d-flex">
                                        <img src="{{ asset('assetPublic/images/faces/face1.jpg') }}" alt="user">
                                        <div>
                                ...
                                <li>
                                    <div class="d-flex">
                                        <img src="{{ asset('assetPublic/images/faces/face2.jpg') }}" alt="user">
                                        <div>
                                ...
                                <li>
                                    <div class="d-flex">
                                        <img src="{{ asset('assetPublic/images/faces/face3.jpg') }}" alt="user">
                                        <div>
                                ...
                                <li>
                                    <div class="d-flex">
                                        <img src="{{ asset('assetPublic/images/faces/face4.jpg') }}" alt="user">
                                        <div>
                                ...
                                <li>
                                    <div class="d-flex">
                                        <img src="{{ asset('assetPublic/images/faces/face5.jpg') }}" alt="user">
                                        <div>
